...
export default function StatsPanel({
  ...
  if (!stats && loading) {
    return (
      <aside className="fixed inset-x-0 bottom-0 z-20 max-h-[70vh] overflow-y-auto rounded-t-2xl border border-slate-700 bg-surface/95 p-4 pb-safe backdrop-blur md:inset-y-0 md:right-0 md:left-auto md:max-h-none md:w-[420px] md:rounded-none md:p-6">
        <div className="mx-auto mb-3 h-1.5 w-10 rounded-full bg-slate-700 md:hidden" />
  ...
  return (
    <aside className="fixed inset-x-0 bottom-0 z-20 max-h-[72vh] overflow-y-auto rounded-t-2xl border border-slate-700 bg-surface/95 p-4 pb-safe backdrop-blur md:inset-y-0 md:right-0 md:left-auto md:max-h-none md:w-[420px] md:rounded-none md:p-6">
      <div className="mx-auto mb-3 h-1.5 w-10 rounded-full bg-slate-700 md:hidden" />
      ...
      {error ? (
        <div className="mb-4 rounded-lg border border-alert-red/50 bg-alert-red/10 px-3 py-2 text-xs text-red-200">
          {error}
        </div>
      ) : null}
